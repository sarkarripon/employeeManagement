                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    <div> <span class="fw-bolder">Employee ID:</span> <small class="ms-3"><?php echo $rows['id'];?></small> </div>
                                </div>
                                <div class="col-md-6">
                                    <div> <span class="fw-bolder">Employee Name: </span> <small class="ms-3"><?php echo $rows['fname']. " ". $rows['lname'];?></small> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div> <span class="fw-bolder">Blood group:</span> <small class="ms-3"><?php echo $rows['bgroup'];?></small> </div>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-6">
                                    <div> <span class="fw-bolder">Designation:</span> <small class="ms-3"><?php echo $rows['designation'];?></small> </div>
                                </div>
                                <div class="col-md-6">
                                    <div> <span class="fw-bolder">Bank Ac No:</span> <small class="ms-3">*******0701</small> </div>
                                </div>
                            </div>
                        ...
                        <div class="row border col-md-12" >
                            ...
                            <?php foreach ($totalAmountRows as $row):?>
                                <li > <span >Year <?php  echo $row['year'];?>: <?php  echo $row['totalAmount'];?> </span> </li>
                            <?php endforeach;?>
                            </ul>
                        </div>
                        <br><br>
                    ...
                    <div class="row">
                        <div class="col-md-4"> <br> <span class="fw-bold">Net Pay : <?php echo $netPayResultRows[0]['netPay'];?>/=</span> </div>
                        <div class="border col-md-8">
                            <div class="d-flex flex-column"> <span>In Words:</span> <span> <?php  echo convertNumberToWords($netPayResultRows[0]['netPay']); ?></span> </div>
                        </div>
                    </div>
